...
import DoppioAvatar from './DoppioAvatar';
...
class DoppioChat extends React.Component {
  constructor(props) {
    super(props);
  ...
  static append(currentMessages = [], messages) {
    console.log("-XX->Chat::append: " + JSON.stringify(messages));
  ...
  // Test
  onPressAvatar(user) {
    console.log("-XXX->OnAvatarPressed! user"+user);
  }
  ...
  renderInputToolbar() {
    ...
    if (this.props.renderInputToolbar) {
      //console.log("-XXX->Chat, props.renderInputToolbar!");
      return this.props.renderInputToolbar(inputToolbarProps);
    }
    //console.log("-XXX->Chat, InputToolbar!");    
    return (
      <InputToolbar
        {...inputToolbarProps}
      />
...
DoppioChat.childContextTypes = {
  actionSheet: PropTypes.func,
  getLocale: PropTypes.func,
};

DoppioChat.defaultProps = {
  messages: [],
  text: undefined,
